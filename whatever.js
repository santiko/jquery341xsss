            ...
            (function() {
                ...
                function() {
                    ...
                    s.disableElement = function(r) {
                        ...
                        c(i, s.linkDisableSelector) ? n(i) : c(i, s.buttonDisableSelector) || c(i, s.formDisableSelector) ? t(i) : c(i, s.formSubmitSelector) ? e(i) : void 0
                    }
                    ,
                    n = function(t) {
                        var e;
                        if (!u(t, "ujs:disabled"))
                            return null != (e = t.getAttribute("data-disable-with")) && (h(t, "ujs:enable-with", t.innerHTML),
                            t.innerHTML = e),
                    ...
                    t = function(t) {
                        var e;
                        if (!u(t, "ujs:disabled"))
                            return null != (e = t.getAttribute("data-disable-with")) && (c(t, "button") ? (h(t, "ujs:enable-with", t.innerHTML),
                            t.innerHTML = e) : (h(t, "ujs:enable-with", t.value),
                            t.value = e)),
                            t.disabled = !0,
                            h(t, "ujs:disabled", !0)
                    }
                    ...
                    r = function(t) {
                        var e;
                        return null != (e = u(t, "ujs:enable-with")) && (c(t, "button") ? t.innerHTML = e : t.value = e,
                        h(t, "ujs:enable-with", null)),
                        t.disabled = !1,
                        h(t, "ujs:disabled", null)
                    }
                ...
                function() {
                    var t;
                    t = s.stopEverything,
                    s.handleMethod = function(e) {
                        var n, r, i, o, a, u;
                        if (this,
                        u = this.getAttribute("data-method"))
                            return a = s.href(this),
                            r = s.csrfToken(),
                            n = s.csrfParam(),
                            i = document.createElement("form"),
                            o = "<input name='_method' value='" + u + "' type='hidden' />",
                            null == n || null == r || s.isCrossDomain(a) || (o += "<input name='" + n + "' value='" + r + "' type='hidden' />"),
                            o += '<input type="submit" />',
                            i.method = "post",
                            i.action = a,
                ...
                function() {
                    ...
                    s.handleRemote = function(h) {
                        var d, p, f, y, m, v, b;
                        return !i(y = this) || (e(y, "ajax:before") ? (b = y.getAttribute("data-with-credentials"),
                        f = y.getAttribute("data-type") || "script",
                        o(y, s.formSubmitSelector) ? (d = n(y, "ujs:submit-button"),
                        m = n(y, "ujs:submit-button-formmethod") || y.method,
                        v = n(y, "ujs:submit-button-formaction") || y.getAttribute("action") || location.href,
                        "GET" === m.toUpperCase() && (v = v.replace(/\?.*$/, "")),
                        "multipart/form-data" === y.enctype ? (p = new FormData(y),
                        null != d && p.append(d.name, d.value)) : p = a(y, d),
                        u(y, "ujs:submit-button", null),
                        u(y, "ujs:submit-button-formmethod", null),
                        u(y, "ujs:submit-button-formaction", null)) : o(y, s.buttonClickSelector) || o(y, s.inputChangeSelector) ? (m = y.getAttribute("data-method"),
                        v = y.getAttribute("data-url"),
                        p = a(y, y.getAttribute("data-params"))) : (m = y.getAttribute("data-method"),
                        v = s.href(y),
                        p = y.getAttribute("data-params")),
                        t({
                            type: m || "GET",
                            url: v,
                            data: p,
                            ...
                            beforeSend: function(t, n) {
                                return e(y, "ajax:beforeSend", [t, n]) ? e(y, "ajax:send", [t]) : (e(y, "ajax:stopped"),
                                !1)
                            },
                            success: function() {
                                var t;
                    ...
                    s.formSubmitButtonClick = function(t) {
                        ...
                        if (this,
                        e = this.form)
                            return this.name && u(e, "ujs:submit-button", {
                                name: this.name,
                                value: this.value
                            }),
                            u(e, "ujs:formnovalidate-button", this.formNoValidate),
                            u(e, "ujs:submit-button-formaction", this.getAttribute("formaction")),
                ...
                .call(this),
                function() {
                    var t, e, n, r, i, o, a, u, l, c, h, d, p, f, y;
                    if (o = s.fire,
                    n = s.delegate,
                    u = s.getData,
                    t = s.$,
                    ...
                    s.start = function() {
                        ...
                        n(document, s.inputChangeSelector, "change", l),
                        n(document, s.inputChangeSelector, "change", d),
                        n(document, s.formSubmitSelector, "submit", c),
                        n(document, s.formSubmitSelector, "submit", l),
                        n(document, s.formSubmitSelector, "submit", d),
                        n(document, s.formSubmitSelector, "submit", (function(t) {
                        ...
                        n(document, s.formInputClickSelector, "click", f),
                        n(document, s.formInputClickSelector, "click", c),
                        n(document, s.formInputClickSelector, "click", l),
                        n(document, s.formInputClickSelector, "click", a),
                        document.addEventListener("DOMContentLoaded", y),
                        document.addEventListener("DOMContentLoaded", p),
                        window._rails_loaded = !0
                    }
                    ,
                    window.Rails === s && o(document, "rails:attachBindings") && s.start()
                }
                .call(this)
            }
            ).call(this),
            "object" === o(t) && t.exports ? t.exports = s : void 0 === (i = "function" === typeof (r = s) ? r.call(e, n, e, t) : r) || (t.exports = i)
        }
        ).call(this)
    }
    ).call(this, n(0)(t))
            ...
            (function() {
                (function() {
                    ...
                    s.throttle = function(t) {
                        ...
                        function() {
                            var n;
                            return n = 1 <= arguments.length ? r.call(arguments, 0) : [],
                            null != e ? e : e = requestAnimationFrame(function(r) {
                                return function() {
                                    return e = null,
                                    t.apply(r, n)
                                }
                    ...
                    n = function() {
                        var t;
                        return (t = document.createEvent("Events")).initEvent("test", !0, !0),
                        t.preventDefault(),
                        t.defaultPrevented
                    }(),
                ...
                function() {
                    ...
                    s.HttpRequest = function() {
                        function e(e, n, r) {
                            ...
                            this.url = s.Location.wrap(n).requestURL,
                            this.referrer = s.Location.wrap(r).absoluteURL,
                            this.createXHR()
                        }
                ...
                function() {
                    s.BrowserAdapter = function() {
                        function t(t) {
                            ...
                            this.progressBar = new s.ProgressBar
                        }
                        var e, n, r;
                ...
                function() {
                    ...
                    s.History = function() {
                        ...
                        e.prototype.onPopState = function(t) {
                            var e, n, r, i;
                            return this.shouldHandlePopState() && (i = null != (n = t.state) ? n.turbolinks : void 0) ? (e = s.Location.wrap(window.location),
                ...
                function() {
                    s.HeadDetails = function() {
                        function t(t) {
                            ...
                            n = 0,
                            s = t.length; s > n; n++)
                                (a = t[n]).nodeType === Node.ELEMENT_NODE && (r = a.outerHTML,
                                (null != (e = this.elements)[r] ? e[r] : e[r] = {
                                    type: o(a),
                                    tracked: i(a),
                                    elements: []
                                }).elements.push(a))
                ...
                function() {
                    s.Snapshot = function() {
                        ...
                        t.fromHTMLElement = function(t) {
                            var e, n, r;
                            return n = t.querySelector("head"),
                            e = null != (r = t.querySelector("body")) ? r : document.createElement("body"),
                            new this(s.HeadDetails.fromHeadElement(n),e)
                        }
                        ,
                ...
                function() {
                    ...
                    s.Renderer = function() {
                        ...
                        return e.render = function() {
                            ...
                            }(this, 3 <= arguments.length ? t.call(arguments, 2) : [], (function() {}
                            ))).delegate = n,
                            r.render(e),
                            r
                        }
                ...
                function() {
                    ...
                    s.SnapshotRenderer = function(r) {
                        ...
                        i.prototype.replaceBody = function() {
                            var t;
                            return t = this.relocateCurrentBodyPermanentElements(),
                        ...
                        i.prototype.relocateCurrentBodyPermanentElements = function() {
                            ...
                            for (u = [],
                            n = 0,
                            r = (a = this.getCurrentBodyPermanentElements()).length; r > n; n++)
                                o = a[n],
                                s = t(o),
                        ...
                        i.prototype.activateNewBodyScriptElements = function() {
                            ...
                            for (s = [],
                            n = 0,
                            i = (o = this.getNewBodyScriptElements()).length; i > n; n++)
                                r = o[n],
                    ...
                    t = function(t) {
                        var e;
                        return (e = document.createElement("meta")).setAttribute("name", "turbolinks-permanent-placeholder"),
                ...
                function() {
                    s.ScrollManager = function() {
                        function t(t) {
                            ...
                            this.onScroll = s.throttle(this.onScroll)
                        }
                ...
                function() {
                    s.Visit = function() {
                        function t(t, e, n) {
                            ...
                            this.identifier = s.uuid(),
                            this.location = s.Location.wrap(e),
                        ...
                        t.prototype.changeHistory = function() {
                            ...
                            n = e(t),
                            this.controller[n](this.location, this.restorationIdentifier),
                            this.historyChanged = !0)
                        }
                        ,
                        t.prototype.issueRequest = function() {
                            return this.shouldIssueRequest() && null == this.request ? (this.progress = 0,
                            this.request = new s.HttpRequest(this,this.location,this.referrer),
                        ...
                        t.prototype.requestCompletedWithResponse = function(t, e) {
                            ...
                            null != e && (this.redirectedToLocation = s.Location.wrap(e)),
                ...
                function() {
                    ...
                    s.Controller = function() {
                        function e() {
                            ...
                            this.history = new s.History(this),
                            this.view = new s.View(this),
                            this.scrollManager = new s.ScrollManager(this),
                            this.restorationData = {},
                            this.clearCache(),
                            this.setProgressBarDelay(500)
                        }
                        return e.prototype.start = function() {
                            return s.supported && !this.started ? (addEventListener("click", this.clickCaptured, !0),
                        ...
                        e.prototype.startVisitToLocationWithAction = function(t, e, n) {
                            var r;
                            return s.supported ? (r = this.getRestorationDataForIdentifier(n),
                            this.startVisit(t, e, {
                                restorationData: r
                            })) : window.location = t
                        }
                        ...
                        e.prototype.startHistory = function() {
                            return this.location = s.Location.wrap(window.location),
                        ...
                        e.prototype.pushHistoryWithLocationAndRestorationIdentifier = function(t, e) {
                            ...
                            this.location = s.Location.wrap(t),
                        ...
                        e.prototype.createVisit = function(t, e, n) {
                            var r, i, o, a, u;
                            return a = (i = null != n ? n : {}).restorationIdentifier,
                            o = i.restorationData,
                            r = i.historyChanged,
                            (u = new s.Visit(this,t,e)).restorationIdentifier = null != a ? a : s.uuid(),
                            u.restorationData = s.copyObject(o),
                            u.historyChanged = r,
                        ...
                        e.prototype.getVisitableLocationForLink = function(t) {
                            var e;
                            return e = new s.Location(t.getAttribute("href")),
                ...
                function() {
                    var t, e, n;
                    s.start = function() {
                        return e() ? (null == s.controller && (s.controller = t()),
                        s.controller.start()) : void 0
                    }
                    ,
                    e = function() {
                        return null == window.Turbolinks && (window.Turbolinks = s),
                        n()
                    }
                    ,
                    t = function() {
                        var t;
                        return t = new s.Controller,
                        t.adapter = new s.BrowserAdapter(t),
                        t
                    }
                    ,
                    (n = function() {
...
, function(t, e, n) {
    ...
    s = function(t) {
        ...
        var e = function(t, e) {
            ...
            t.exports = function(t) {
                ...
                function o(t) {
                    var e, i, o, s, a, u, l = t.length, c = [1732584193, -271733879, -1732584194, 271733878];
                    for (e = 64; e <= l; e += 64)
                    ...
                    e > 55)
                        ...
                        e = 0; e < 16; e += 1)
                            o[e] = 0;
                    return s = (s = 8 * l).toString(16).match(/(.*?)(.{0,8})$/),
                    a = parseInt(s[2], 16),
                    u = parseInt(s[1], 16) || 0,
                    o[14] = a,
                    o[15] = u,
                ...
                "undefined" === typeof ArrayBuffer || ArrayBuffer.prototype.slice || function() {
                    ...
                    ArrayBuffer.prototype.slice = function(n, r) {
                        var i, o, s, a, u = this.byteLength, l = e(n, u), c = u;
                        return r !== t && (c = e(r, u)),
                ...
                c.ArrayBuffer.prototype.append = function(t) {
                    var e, r, o, s, a, u = (r = this._buff.buffer,
                    o = t,
                    s = !0,
                    (a = new Uint8Array(r.byteLength + o.byteLength)).set(new Uint8Array(r)),
                    a.set(new Uint8Array(o), r.byteLength),
                    s ? a : a.buffer), l = u.length;
                    for (this._length += t.byteLength,
                    e = 64; e <= l; e += 64)
                        n(this._hash, i(u.subarray(e - 64, e)));
                    return this._buff = e - 64 < l ? new Uint8Array(u.buffer.slice(e - 64)) : new Uint8Array(0),
                    this
                }
                ,
                ...
                c.ArrayBuffer.hash = function(t, e) {
                    var r = a(function(t) {
                        var e, r, o, s, a, u, l = t.length, c = [1732584193, -271733879, -1732584194, 271733878];
                        for (e = 64; e <= l; e += 64)
            ...
            r(t, [{
                ...
                value: function(t) {
                    ...
                    this.fileReader.addEventListener("load", (function(t) {
                        return n.fileReaderDidLoad(t)
                    }
                    )),
                    this.fileReader.addEventListener("error", (function(t) {
                        return n.fileReaderDidError(t)
                    }
                    )),
                    this.readNextChunk()
                }
        ...
        var l = function() {
            function t(e, r, i) {
                ...
                var a = function(t) {
                    var e = s(document.head, 'meta[name="' + t + '"]');
                    if (e)
                        return e.getAttribute("content")
                }("csrf-token");
                void 0 != a && this.xhr.setRequestHeader("X-CSRF-Token", a),
          ...
          , c = function() {
            function t(e) {
                ...
                this.xhr.open("PUT", o, !0),
                this.xhr.responseType = "text",
                s)
                    this.xhr.setRequestHeader(a, s[a]);
                this.xhr.addEventListener("load", (function(t) {
                ...
                value: function(t) {
                    ...
                    o.create(this.file, (function(n, r) {
                        if (n)
                            ...
                            var i = new l(e.file,r,e.url);
                            p(e.delegate, "directUploadWillCreateBlobWithXHR", i.xhr),
                            i.create((function(n) {
                                if (n)
                                    t(n);
                                else {
                                    var r = new c(i);
                                    p(e.delegate, "directUploadWillStoreFileWithXHR", r.xhr),
                                    r.create((function(e) {
        ...
        var f = function() {
            function t(e, r) {
                ...
                this.input = e,
                this.file = r,
                this.directUpload = new d(this.file,this.url,this),
          ...
          , y = function() {
            function t(e) {
                ...
                this.form = e,
                this.inputs = (r = e,
                i = "input[type=file][data-direct-upload-url]:not([disabled])",
                "string" == typeof r && (i = r,
                r = document),
                u(r.querySelectorAll(i))).filter((function(t) {
            ...
            return r(t, [{
                ...
                value: function(t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                    return a(this.form, "direct-uploads:" + t, {
                        detail: e
                    })
                }
            }]),
        ...
        function g(t) {
            var e = t.target;
            "INPUT" != e.tagName && "BUTTON" != e.tagName || "submit" != e.type || !e.form || m.set(e.form, e)
        }
        function S(t) {
            w(t)
        }
        function E(t) {
            "FORM" == t.target.tagName && w(t)
        }
        function w(t) {
            var e = t.target;
            if (e.hasAttribute("data-direct-uploads-processing"))
                t.preventDefault();
            else {
                var n = new y(e)
                  , r = n.inputs;
                r.length && (t.preventDefault(),
                e.setAttribute("data-direct-uploads-processing", ""),
                r.forEach(k),
                n.start((function(t) {
                    e.removeAttribute("data-direct-uploads-processing"),
                    t ? r.forEach(C) : function(t) {
                        var e = m.get(t) || s(t, "input[type=submit], button[type=submit]");
                        if (e) {
                            var n = e.disabled;
                            e.disabled = !1,
                            e.focus(),
    ...
    ,
    "object" === a(e) && "undefined" !== typeof t ? s(e) : (i = [e],
...
//# sourceMappingURL=application-71347c2f2155a8dbefa4.js.map
